...
export const productSchema = z.object({
  ...
  sellsByUnit: z.boolean().default(true),
  unitWeightGrams: z.number().positive("Peso unitário deve ser maior que 0").optional().nullable(),
  pricePerKg: z.number().positive("Preço por kg deve ser maior que 0").optional().nullable(),
